<template>
  ...
  <div class="relative pt-20 px-4 md:px-10 bg-[#ffffff]">
    ...
    >
      <h1 class="text-2xl md:text-3xl lg:text-3xl text-center">
        Top Destinations
      </h1>
      <div class="hidden lg:flex flex-row justify-center gap-4 mt-4">
        <nuxt-link
          ...
          >Home</nuxt-link
        >
        <p class="text-base md:text-lg lg:text-xl">/ Top Destinations</p>
      </div>
    </div>
  </div>
  <div class="px-4 md:px-10 space-y-11 bg-[#ffffff] py-10">
